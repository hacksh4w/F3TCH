...
pragma solidity ^0.8.0; //fix import node modules, line 6
 ...
 */
contract F3TCHERCToken is ERC20Burnable, ERC20Pausable, Ownable {
    /**
     * @dev Mints an initial supply of 3.25 Billion FTH tokens with 18 decimals and
